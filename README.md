...
Install Arduino IDE 2.3.8 and you can use photodiode_sketch.ino to upload to the arduino and then use the serial monitor (button on the far right top that looks like a spy glass with 4 dots) to test. You should see 6 numbers seperated by commas pertaining to each photodiode. If you see squares and not numbers is probably because your BAUD isn't the right value (in this code it is 9600). 
